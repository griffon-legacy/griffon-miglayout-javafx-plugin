...
//
// check to see if we already have a MiglayoutJavafxGriffonAddon
// def configText = '''root.'MiglayoutJavafxGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing MiglayoutJavafxGriffonAddon from Builder.groovy'
